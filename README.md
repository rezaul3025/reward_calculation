...
Note :
    ...
    - Opern exchange service is mock for testing and mock is available when active is test at -> com.reward.api.service.external.mock.MockOpenExchangeApiService.java 
